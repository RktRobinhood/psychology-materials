...
(function () {
  ...
  DPT.register({
    ...
    concepts: [
      { name: 'Measurement', html: `Base-rate neglect is usually measured with a single estimate on a word problem, like the taxi question you answered. The same information given as natural frequencies (“12 out of 29”) produces far more correct answers than percentages do. So how we <b>measure</b> the bias changes how big it looks, which raises the question of whether an abstract word problem is a valid measure of how people reason in real life.` },
      { name: 'Perspective', html: `Kahneman and Tversky see the taxi results as evidence of a System 1 shortcut that ignores base rates. Gigerenzer offers a different perspective: human minds evolved to handle frequencies from experience, not percentages on paper, so the “bias” partly reflects an unnatural format. The same data can support either view, depending on what you think the task is really testing.` },
      { name: 'Responsibility', html: `Doctors, courts and security services all act on evidence about rare events. A doctor who tells a patient “the test is 90% accurate” without explaining that most positives are false alarms can cause real fear and unnecessary treatment. Professionals have a responsibility to present risks in a form people can understand, such as “9 out of 98 people who test positive are ill”.` },
      { name: 'Change', html: `Base-rate neglect is not fixed. When doctors are trained to translate percentages into natural frequencies, their accuracy on screening problems improves markedly. This shows that thinking can be changed by changing how information is presented, without changing the person.` },
    ],
    debate: {
      title: 'Do people really ignore base rates?',
      sideA: { label: 'Base rates are neglected (Kahneman & Tversky, 1973; Tversky & Kahneman, 1980, 1982)', html: `In the engineer/lawyer study, participants’ judgements about “Jack” barely changed when the base rate flipped from 30% to 70% engineers. In the taxi problem, the most common answer was 80%, the witness’s accuracy, instead of about 41%. Both used university students answering short written problems with the numbers given as percentages.` },
      sideB: { label: 'Base rates are often used (Gigerenzer & Hoffrage, 1995; Koehler, 1996)', html: `Gigerenzer and Hoffrage gave the same kind of problem as natural frequencies (“10 out of 1,000”) and correct answers rose sharply, to roughly half of participants. Koehler reviewed a large body of research and argued that people do use base rates in many situations, especially when base rates are clearly relevant or learned from experience, and that the claim of general neglect was exaggerated.` },
      why: [
        { factor: 'Format', html: `Percentages (“15%”, “80%”) must be combined by calculation. Natural frequencies do much of that work for you, because the counts can simply be added. The two sides often used different formats, so they may be measuring maths difficulty as much as a thinking bias.` },
        { factor: 'Ecological validity', html: `Classic studies used one-off word problems about imaginary cities. In real life we usually learn base rates by experience (how often it rains, how often a friend is late). Koehler argued that neglect in artificial tasks may not tell us much about everyday judgement.` },
        { factor: 'Relevance of the base rate', html: `In the taxi problem, is “85% of taxis are Green” really relevant to which taxi was in an accident at night? When the base rate was made causal (85% of <i>accidents</i> involve Green taxis), people used it more. Participants may have been judging relevance, not ignoring information.` },
        { factor: 'What counts as “correct”', html: `The 41% answer assumes the witness’s tested accuracy applies exactly to this accident and that the base rate is the right starting point. Critics point out that these assumptions are debatable, so some “wrong” answers may be reasonable readings of an ambiguous problem.` },
      ],
      trust: `Both sets of findings are reliable: the taxi and engineer/lawyer results have been replicated many times, and so has the natural-frequency improvement. They disagree less about the data than about what the data mean. The safest conclusion is the narrower one: people <b>tend to underuse base rates when they are given as abstract percentages</b>, and the error shrinks a lot with frequencies or experience. The strong claim that humans generally ignore base rates is not well supported, so we should trust the combined picture more than either side alone.`,
      ask: 'If doctors reason much better when the same numbers are given as frequencies, is base-rate neglect a flaw in people’s thinking or a flaw in how statistics are presented?',
    },
    quiz: {
      core: [
        ...
        { q: 'Why do Gigerenzer & Hoffrage’s (1995) findings challenge the claim that people generally ignore base rates?', a: 'Accuracy rose sharply when the same information was given as natural frequencies', d: ['Doctors ignored base rates even more than students did in every format', 'Participants refused to answer when the numbers were given as frequencies', 'Accuracy stayed exactly the same whichever format the numbers were in'], why: 'If changing only the format makes many more people use the base rate, the problem is partly presentation, not a fixed flaw in thinking.' },
      ],
      extra: [
        ...
        { q: 'A doctor explains a positive screening result as “about 9 in every 98 people who test positive have the disease” instead of “the test is 90% accurate”. Which IB concept does this best illustrate?', a: 'Responsibility: presenting risk in a way patients can understand correctly', d: ['Causality: showing that the test causes the disease to be detected', 'Measurement: changing the test so that it becomes more reliable', 'Perspective: comparing a cultural view of illness with a biological one'], why: 'The test is unchanged. The doctor is taking responsibility for communicating the result so it doesn’t mislead.' },
      ],
    },
  });
})();
