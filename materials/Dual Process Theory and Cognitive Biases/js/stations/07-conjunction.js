...
(function () {
  ...
  function reveal(res, ctx) {
    ...
    else verdict = `<b>You avoided the conjunction fallacy.</b> You ranked “${S.short.single}” above “${S.short.both}”, and your numbers agree (${res.freqA} versus ${res.freqAB}). That's unusual: most people rank the combined statement higher. The next screens explain why.`;
  ...
  DPT.register({
    ...
    concepts: [
      { name: 'Measurement', html: `The Linda problem measures probability judgement by asking people to rank statements by how “probable” they are. When the same question is asked as a frequency (“how many of 100 women like Linda…”), the fallacy drops sharply. So the result depends heavily on how the question is worded, which raises a validity question: is the ranking task measuring faulty reasoning, or how people understand the word “probable”?` },
      { name: 'Perspective', html: `Kahneman and Tversky's heuristics-and-biases perspective sees the error as System 1 substituting similarity for probability. Gigerenzer and Hertwig take a different perspective: the mind is well suited to reasoning about frequencies, and people follow the normal rules of conversation when they read the problem. The same finding (most people rank “bank teller and feminist” higher) is explained in two quite different ways.` },
      { name: 'Bias', html: `The representativeness heuristic is closely linked to stereotyping: Linda is judged by how well she fits a picture of a typical feminist, and Bill by how well he fits a picture of a typical accountant. The descriptions were also deliberately written to fit a stereotype. That is fair for showing that the bias exists, but it may make the bias look larger than it is in everyday judgements.` },
      { name: 'Responsibility', html: `Detailed stories feel more likely even as they become less probable. Lawyers, journalists and forecasters who add vivid details can make a scenario more persuasive without making it more likely. Using this knowledge responsibly means asking how many separate things must all be true for a story to hold.` },
    ],
    debate: {
      title: 'Is the Linda problem a reasoning error or a misunderstanding?',
      sideA: { label: 'A real reasoning error (Tversky & Kahneman, 1983)', html: `About 85% of participants judged “Linda is a bank teller and is active in the feminist movement” more probable than “Linda is a bank teller”. Graduate students with advanced training in statistics made the error at similar rates. Tversky and Kahneman concluded that people judge by representativeness and ignore the conjunction rule.` },
      sideB: { label: 'Mostly a misunderstanding (Fiedler, 1988; Hertwig & Gigerenzer, 1999)', html: `When the problem was asked in frequencies (“There are 100 people like Linda. How many are bank tellers? How many are bank tellers and feminists?”), the fallacy fell sharply. Hertwig and Gigerenzer argued that “probable” has many everyday meanings, such as “plausible” or “fits the description”, and that many participants were not using it in the mathematical sense at all.` },
      why: [
        { factor: 'Wording', html: `In everyday language “probable” often means “believable” or “makes sense”. On that meaning, “bank teller and feminist” really is the better answer. Frequency wording removes this ambiguity, because “how many” only has one sensible meaning.` },
        { factor: 'Conversational norms', html: `In normal conversation we assume every option is there for a reason. Seeing “bank teller and feminist” next to “bank teller”, people may read the plain statement as “bank teller who is <i>not</i> a feminist”. Then ranking the combined statement higher is not a logical error.` },
        { factor: 'Response format', html: `Ranking a list of statements and estimating counts out of 100 are different tasks. Counting makes people picture a group and then a smaller group inside it, so the subset relationship becomes visible.` },
        { factor: 'Researcher perspective', html: `Each side designed tasks that tested its own theory. Researchers who expect a bias may choose wording that shows it; researchers who expect good reasoning may choose wording that removes it. This is one reason the two sides tried an adversarial collaboration.` },
      ],
      trust: `Both findings are reliable: the original fallacy and the drop with frequency wording have both been replicated many times. The frequency result shows that people are not simply unable to use the conjunction rule, so a misunderstanding of the question probably explains some of the original effect. But misunderstanding is unlikely to explain all of it, because the error still appears in some versions designed to rule out misreadings. In an adversarial collaboration, Mellers, Hertwig and Kahneman (2001) designed a study together; as generally reported, frequency wording reduced the fallacy but did not remove it in every version, so neither side was fully proved right. A study designed by rivals together is especially trustworthy, because it is harder for either side's expectations to bias the design.`,
      ask: 'If people get the answer right when they count but wrong when they judge “probability”, do they really have the bias or not?',
    },
    quiz: {
      core: [
        ...
        { q: 'What is an <b>adversarial collaboration</b>, like the one by Mellers, Hertwig & Kahneman (2001)?', a: 'Researchers with opposing views design and run a study together', d: ['Two teams race each other to publish opposite findings', 'A study in which participants argue against each other', 'A review that combines the results of many earlier studies'], why: 'Rivals agree the design in advance, which makes it harder for either side’s expectations to bias the study.' },
      ],
      extra: [
        ...
        { q: 'Why might someone read “Linda is a bank teller” as “Linda is a bank teller who is <b>not</b> a feminist”?', a: 'In conversation we assume each option is there to tell us something new', d: ['The description of Linda says that she is not a feminist', 'Bank tellers are not allowed to take part in politics', 'The frequency wording forces people to read it that way'], why: 'Next to “bank teller and feminist”, the plain statement seems to mean the opposite case. On that reading, ranking the combined statement higher is not a logical error.' },
      ],
    },
  });
})();
