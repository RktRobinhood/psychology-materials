    ...
    steps: [
      {
        ...
        html: res => `${STYLE}<p>Here is exactly what you saw. Each square is one statement.</p>
          ...
          ${countTable(res, false)}
          ${ui.steps([
            `${g(res.big)} had <b>twice as many statements</b> as ${g(res.small)} (18 vs 9). That is the only real difference between them.`,
