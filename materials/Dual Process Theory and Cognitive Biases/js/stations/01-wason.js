...
(function () {
  ...
  DPT.register({
    ...
    concepts: [
      { name: 'Perspective', html: 'Everyone agrees the drinking-age version is easier, but not on <b>why</b>. The dual process perspective says concrete content lets System 1 get it right. An evolutionary perspective says we have a built-in ability to catch cheaters. A learning perspective says we simply remember real rules about permission. Same data, three explanations.' },
      { name: 'Causality', html: 'Griggs & Cox <b>manipulated</b> the content of the rule while keeping the logic the same, so they can claim the content <b>caused</b> the change in performance. Goel et al. only <b>observed</b> brain activity during the task. fMRI is correlational: it can’t show that the parietal lobe causes abstract reasoning.' },
      { name: 'Measurement', html: 'The task scores reasoning as all-or-nothing: you either pick exactly the right cards or you are wrong. Is picking the wrong cards really a measure of “System 1 thinking”? It might instead measure low motivation, misreading the rule, or not knowing what “test the rule” means.' },
      { name: 'Change', html: 'Wason found that <b>training didn’t transfer</b>: people taught the right answer went back to matching when the content changed. That suggests System 1 habits are hard to change just by teaching a rule, which matters for anyone trying to “debias” thinking.' },
    ],
    debate: {
      title: 'Why is the drinking-age version so much easier?',
      sideA: { label: 'Familiarity: Griggs & Cox (1982)', html: 'About 75% solved the drinking-age version. The explanation offered was <b>memory and experience</b>: people have seen age rules enforced, so they know which cases to check. If that is right, only rules you have met before should be easy.' },
      sideB: { label: 'Cheater detection: Cosmides (1989)', html: 'Participants were given <b>unfamiliar</b> rules from an invented culture, written as social exchanges (“if you take the benefit, you must pay the cost”). Many still solved them. Cosmides argued we have an <b>evolved ability to detect cheaters</b>, not just memories of familiar rules.' },
      why: [
        { factor: 'Operationalisation', html: 'What counts as “familiar” or “concrete”? Each researcher defined it differently, so the studies may not be testing the same thing.' },
        { factor: 'Wording', html: 'Cosmides’ rules were about permission and obligation (“must”). Critics such as Cheng & Holyoak (1985) argue that any permission rule is easier, whether or not it involves cheating. The wording, not evolution, might do the work.' },
        { factor: 'Samples', html: 'Most studies used Western university students. We can’t be sure an “evolved” ability is universal without testing people from very different cultures.' },
        { factor: 'Theory-driven design', html: 'Each side tends to design tasks that suit its own theory. That is a form of researcher bias, and it makes the results hard to compare.' },
      ],
      trust: 'Trust the part that <b>everyone replicates</b>: content matters a great deal, and rules about permission and obligation are far easier than abstract ones. The explanation is still debated. Cosmides’ unfamiliar rules are a problem for a pure memory explanation, but they don’t prove an evolved module, because permission wording alone could explain them. When studies agree on the <i>finding</i> but not the <i>explanation</i>, the safest conclusion is the finding.',
      ask: 'If people can solve an unfamiliar social rule, is that System 1 or System 2 at work? What would you need to measure to find out?',
    },
    host: {
      checklist: [
    ...
    quiz: {
      core: [
        ...
        { q: 'Why can’t Goel et al. (2000) conclude that the parietal lobe <b>causes</b> abstract reasoning?', a: 'fMRI only shows which areas are active during a task, which is a correlation', d: ['The sample was too large to analyse properly', 'The participants did not complete the task', 'The parietal lobe is not involved in thinking'], why: 'Activity during a task is correlational. Other areas, or other processes, could be doing the causal work.' },
      ...
      extra: [
        ...
        { q: 'Cosmides (1989) found people could solve <b>unfamiliar</b> rules written as social exchanges. Which explanation does this challenge most?', a: 'That the drinking version is easy only because people remember real age rules', d: ['That the abstract version is harder than the concrete one', 'That matching bias exists in the abstract version', 'That people often pick the cards named in the rule'], why: 'If only memory mattered, unfamiliar rules should be as hard as abstract ones. They weren’t.' },
