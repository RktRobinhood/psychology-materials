...
(function () {
  ...
  // Hypotheses vs test sequences: which ideas each test could rule out.
  const HYP = [
  ...
  DPT.register({
    ...
    host: {
      checklist: [
        ...
        { point: 'System 1 vs System 2', hint: 'System 1: looks for a “yes” (positive test strategy); each ✓ feels like progress. System 2: tries to <b>disprove</b> its own idea (falsification).' },
