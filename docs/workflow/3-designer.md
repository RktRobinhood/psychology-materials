...
- **Laptop and phone.** The laptop layout uses the screen's width (no phone-sized column); the phone layout is a real design, not a squashed laptop page. See [Layout](../preferences.md#layout).
...
- Every screen has been looked at in the browser at 1366x650 and at phone width (375).
